...
class chartViewAdapter(private val context: Context, private var chartDataList: List<resultChartData>) : RecyclerView.Adapter<chartViewAdapter.ChartViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ChartViewHolder, position: Int) {
        ...
        holder.binding.resultGraph.addView(temp4)
        holder.binding.resultGraph.addView(temp5)
        holder.binding.resultGraph.addView(temp6)
        holder.binding.resultGraph.addView(temp7)
        holder.binding.resultGraph.addView(temp8)
        holder.binding.resultGraph.addView(temp9)
        holder.binding.resultGraph.addView(temp10)
